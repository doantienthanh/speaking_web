...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__j",
      "vtp_name":"window.digitalData.page.pageInfo.pageName"
    },{
      "function":"__j",
      "vtp_name":"window.digitalData.cart.item"
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){if(\"undefined\"!==typeof ",["escape",["macro",2],8,16],")return ",["escape",["macro",2],8,16],".map(function(a){return a.productInfo.sku}).join()})();"]
    },{
      "function":"__r"
    },{
      "function":"__u",
      ...
      "function":"__j",
      "vtp_name":"digitalData.page.pageInfo.siteContext"
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return\"undefined\"!==typeof ",["escape",["macro",7],8,16],"\u0026\u0026\"\"!==",["escape",["macro",7],8,16],"\u0026\u0026",["escape",["macro",7],8,16],".match(\/gb|uk|ie|fr|de|it|at|ch|us|ca|au|nz\/i)?",["escape",["macro",7],8,16],":document.location.hostname.match(\/(snapfish\\.co\\.uk|^uk\\.sf-)\/i)?\"gb\":document.location.hostname.match(\/(snapfish\\.ie|^ie\\.sf-)\/i)?\"ie\":document.location.hostname.match(\/(snapfish\\.fr|^fr\\.sf-)\/i)?\"fr\":document.location.hostname.match(\/(snapfish\\.de|^de\\.sf-)\/i)?\"de\":document.location.hostname.match(\/(snapfish\\.it|^it\\.sf-)\/i)?\n\"it\":document.location.hostname.match(\/(snapfish\\.at|^at\\.sf-)\/i)?\"at\":document.location.hostname.match(\/(snapfish\\.ch|^ch\\.sf-)\/i)?\"ch\":document.location.hostname.match(\/(snapfish\\.ca|^ca\\.sf-)\/i)?\"ca\":document.location.hostname.match(\/(snapfish\\.com\\.au|^au\\.sf-)\/i)?\"au\":document.location.hostname.match(\/(snapfish\\.com|^us\\.sf-)\/i)?\"us\":document.location.hostname.match(\/(snapfish\\.co\\.nz|^nz\\.sf-)\/i)?\"nz\":\"us\"})();"]
    },{
      "function":"__remm",
      ...
      "vtp_ignoreCase":true,
      "vtp_map":["list",["map","key","(uk|gb)","value","GBP"],["map","key","us","value","USD"],["map","key","(fr|de|at|ie|it)","value","EUR"],["map","key","au","value","AUD"],["map","key","ch","value","AUD"],["map","key","nz","value","NZD"]]
    },{
      "function":"__j",
      "vtp_name":"window.digitalData.page.pageInfo.destinationURL"
    },{
      "function":"__j",
      "vtp_name":"window.digitalData.transaction.item"
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){if(\"undefined\"!==typeof ",["escape",["macro",11],8,16],")return ",["escape",["macro",11],8,16],".map(function(a){return a.productInfo.quantity.toString()}).join(\"|\")})();"]
    },{
      "function":"__j",
      "vtp_name":"window.digitalData.order"
    },{
      "function":"__j",
      "vtp_name":"window.digitalData.order._id"
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){function x(a){return\"undefined\"!=typeof a\u0026\u0026\"\"!=a\u0026null!=a?!0:!1}var m=",["escape",["macro",13],8,16],",p=",["escape",["macro",11],8,16],";if(1==x(m)\u0026\u00261==x(p)){var g=JSON.parse(JSON.stringify(m));JSON.parse(JSON.stringify(p));var n={add:function(a,c){return parseFloat(a)+parseFloat(c)},subtract:function(a,c){return parseFloat(a)-parseFloat(c)},multiply:function(a,c){return parseFloat(a)*parseInt(c)},divide:function(a,c){return parseFloat(a)-parseFloat(c)}};Number.prototype.toFixedDown=function(a){var c=this-\nMath.pow(10,-a)\/2;c+=c\/Math.pow(2,53);return c.toFixed(a)};var C=function(a){return\"undefined\"!=typeof a.skuId?a.skuId.replace(\/CommerceProduct_\/,\"\"):\"undefined\"!=typeof a.optionId?a.optionId.replace(\/CommerceOption_\/,\"\"):a.replace(\/CommerceProduct_\/,\"\")},c=function(a){return 0==a?\"0.00000\":parseFloat(a).toFixedDown(5)},A=function(a,c){return 0==parseFloat(a)\/parseInt(c)?\"0.0000\":(parseFloat(a)\/parseInt(c)).toFixedDown(5)},d=function(a,c){var f=",["escape",["macro",7],8,16],",h=a.productTotal,e=h-a.productDiscount.totalDiscount,\ng=e,d=e,z=0,b=0,t=0,r=0,p=0,u=0,v=0,w=0,m=0,y=0,k;for(k in a.taxInfo.productTax)a.taxInfo.productTax.hasOwnProperty(k)\u0026\u0026(z=a.taxInfo.productTax[k].taxAmount,g=\"us\"!=f?e-z:e);if(!c.match(\/retailpickup\/i)\u0026\u0026!c.match(\/ShipToStore\/i))for(k in p=a.shippingTotal,u=p-a.shippingDiscount.totalDiscount,a.taxInfo.shippingTax)a.taxInfo.shippingTax.hasOwnProperty(k)\u0026\u0026(r=a.taxInfo.shippingTax[k].taxAmount,v=\"us\"!=f?u-r:u);if(c.match(\/mailorder\/i))for(k in a.taxInfo.shippingTax)a.taxInfo.shippingTax.hasOwnProperty(k)\u0026\u0026\n(w+=a.taxInfo.shippingTax[k].taxAmount,t=a.taxInfo.shippingTax[k].taxRate);for(k in a.taxInfo.productTax)a.taxInfo.productTax.hasOwnProperty(k)\u0026\u0026(w+=a.taxInfo.productTax[k].taxAmount,b=a.taxInfo.productTax[k].taxRate);0\u003Ca.productDiscount.totalDiscount\u0026\u0026(y=a.productDiscount.totalDiscount\/(1+b));0\u003Ca.shippingDiscount.totalDiscount\u0026\u0026(m=a.shippingDiscount.totalDiscount\/(1+t));d=n.add(d,u);return a={total_net_tax:w,net_product_discount:y,net_shipping_discount:m,product_gross_discount:a.productDiscount.totalDiscount,\nshipping_gross_discount:a.shippingDiscount.totalDiscount,full_price_with_shipping_no_discount:d,product_price_no_discount:e,unit_price:g,full_price:h,shipping_tax_rate:t,shipping_tax_amount:r,shipping_full_price:p,shipping_price_no_discount:u,net_shipping:v,tax_rate:b,tax_amount:z}},D=function(a,c){a.delivery_method=g.shipBins[c].deliveryMethod;a.delivery_option=g.shipBins[c].deliveryOption;a.shipbin_Id=g.shipBins[c].shipBinId;a.retailer=g.shipBins[c].retailer;a.net_shipping=d(a,a.delivery_method).net_shipping;\na.total_net_tax=d(a,a.delivery_method).total_net_tax;a.net_product_discount=d(a,a.delivery_method).net_product_discount;a.net_shipping_discount=d(a,a.delivery_method).net_shipping_discount;a.unit_price=d(a,a.delivery_method).unit_price;a.full_price=d(a,a.delivery_method).full_price;a.product_gross_discount=d(a,a.delivery_method).product_gross_discount;a.product_price_no_discount=d(a,a.delivery_method).product_price_no_discount;a.full_price_with_shipping_no_discount=d(a,a.delivery_method).full_price_with_shipping_no_discount;\na.tax_rate=d(a,a.delivery_method).tax_rate;a.tax_amount=d(a,a.delivery_method).tax_amount;a.shipping_full_price=d(a,a.delivery_method).shipping_full_price;a.shipping_gross_discount=d(a,a.delivery_method).shipping_gross_discount;a.shipping_price_no_discount=d(a,a.delivery_method).shipping_price_no_discount};m=function(){if(\/\\.*Receipt$\/i.test(",["escape",["macro",1],8,16],")){var a=[];var d=[];for(var f=0;f\u003Cg.shipBins.length;f++)for(var h=0;h\u003Cg.shipBins[f].projects.length;h++)for(var e=0;e\u003Cg.shipBins[f].projects[h].lineItems.length;e++){if(\"object\"==\ntypeof g.shipBins[f].projects[h].lineItems[e].lineItemOptions\u0026\u00260\u003Cg.shipBins[f].projects[h].lineItems[e].lineItemOptions.length)for(var q=0;q\u003Cg.shipBins[f].projects[h].lineItems[e].lineItemOptions.length;q++)D(g.shipBins[f].projects[h].lineItems[e].lineItemOptions[q],f),d.push(g.shipBins[f].projects[h].lineItems[e].lineItemOptions[q]);for(l=0;l\u003Cp.length;l++)g.shipBins[f].projects[h].lineItems[e].skuId==p[l].attributes.ProductUUID\u0026\u0026(g.shipBins[f].projects[h].lineItems[e].attributes=p[l].attributes);\nD(g.shipBins[f].projects[h].lineItems[e],f);d.push(g.shipBins[f].projects[h].lineItems[e])}var m=q=e=h=f=0,B=0;for(i=0;i\u003Cd.length;i++){a[i]={};var b=d[i],t=c(A(b.full_price,b.quantity)),r=c(A(b.unit_price,b.quantity)),x=c(n.multiply(r,b.quantity)),u=b.full_price,v=c(A(b.full_price_with_shipping_no_discount,b.quantity)),w={method:b.delivery_method,option:b.delivery_option};t={unit_price:c(r),unit_price_with_quantity:c(n.multiply(r,b.quantity)),full_price:c(t),product_price_no_discount:c(b.product_price_no_discount),\nfull_price_with_shipping_no_discount:c(v)};r={net_shipping_discount:c(b.net_shipping_discount),net_product_discount:c(b.net_product_discount),gross_product_discount:c(b.product_gross_discount),gross_shipping_discount:c(b.shipping_gross_discount),net_product_discount_with_quantity:c(n.multiply(b.net_product_discount,b.quantity)),net_shipping_discount_with_quantity:c(n.multiply(b.net_shipping_discount,b.quantity)),product_gross_discount_by_quantity:c(n.multiply(b.product_gross_discount,b.quantity))};\nv={net_shipping:c(b.net_shipping),full_price:c(b.shipping_full_price),price_no_discount:c(b.shipping_price_no_discount)};var E={tax_rate:c(b.tax_rate),tax_amount:c(b.tax_amount),net_tax:c(b.total_net_tax)},y={id:\"undefined\"!=typeof b?C(b):\"not-set\",full_id:\"undefined\"!=typeof b\u0026\u0026\"undefined\"!=typeof b.skuId?b.skuId:\"undefined\"!=typeof b\u0026\u0026\"undefined\"!=typeof b.optionId?b.optionId:\"not-set\",sku:\"undefined\"!=typeof b?C(b):\"not-set\",uuid:\"undefined\"!=typeof b\u0026\u0026\"undefined\"!=typeof b.skuId?b.skuId:\"undefined\"!=\ntypeof b\u0026\u0026\"undefined\"!=typeof b.optionId?b.optionId:\"not-set\",name:\"undefined\"!=typeof b.attributes?b.attributes.ProductName:\"\",variant:\"undefined\"!=typeof b.attributes?b.attributes.Size:\"\",shipbin:b.shipbin_Id.toString(),quantity:b.quantity.toString()};a[i].product_info=y;a[i].tax=E;a[i].shipping=v;a[i].discount=r;a[i].revenue=t;a[i].delivery=w;f+=parseFloat(b.total_net_tax);h+=parseFloat(b.net_shipping);e+=parseFloat(b.shipping_full_price);m+=parseFloat(x);q+=parseFloat(u);B+=n.add(b.product_gross_discount,\nb.shipping_gross_discount)}return a={id:",["escape",["macro",14],8,16],".toString(),shipping:{without_tax:c(h),with_tax:c(e)},revenue:{with_tax:c(q),without_tax:c(m)},tax:{total:c(f)},discount:{total:c(B)},total:{with_shipping_and_tax:c(n.add(q,e)),without_tax:c(n.add(m,h)),with_tax_without_discount:c(n.add(q,e)-B)},products:a}}};return m()}return\"No Transaction\"})();"]
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){if(\"undefined\"!==typeof ",["escape",["macro",15],8,16],")return ",["escape",["macro",15],8,16],".products.map(function(a){return(parseFloat(a.revenue.unit_price)*parseInt(a.product_info.quantity)).toFixed(2)}).join(\"|\")})();"]
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){if(\"undefined\"!==typeof ",["escape",["macro",11],8,16],")return ",["escape",["macro",11],8,16],".map(function(a){return a.productInfo.sku}).join(\"|\")})();"]
    },{
      "function":"__j",
      "vtp_name":"window.digitalData.transaction.total.preTaxPrice"
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return parseFloat(",["escape",["macro",18],8,16],").toFixed(2)})();"]
    },{
      "function":"__j",
      "vtp_name":"window.digitalData.user.profile.profileInfo.userAccount"
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var a=",["escape",["macro",20],8,16],".split(\"-\");return a[a.length-1]})();"]
    },{
      "function":"__j",
      "vtp_name":"window.digitalData.transaction.total.voucherCode"
    },{
      "function":"__j",
      "vtp_name":"window.digitalData.transaction.price.transaction.shipping"
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return(parseFloat(",["escape",["macro",18],8,16],")-parseFloat(",["escape",["macro",23],8,16],")).toFixed(2)})();"]
    },{
      "function":"__j",
      "vtp_name":"window.digitalData.page.pageInfo.environment"
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var a=",["escape",["macro",25],8,16],";return\"undefined\"!==typeof a\u0026\u0026a.match(\/prod\/i)?\"prod\":\"undefined\"!==typeof a\u0026\u0026a.match(\/dev|stag|qa\/i)?\"dev\":document.location.hostname.match(\/dev|stag|qa\/i)?\"dev\":document.location.hostname.match(\/\\.snapfish\\.\/i)?\"prod\":\"dev\"})();"]
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return function(c){var b={};0\u003Cdocument.cookie.length\u0026\u0026document.cookie.split(\";\").forEach(function(a){a=a.trim().split(\"\\x3d\");return b[a[0]]=a.slice(1).join(\"\\x3d\")});return b[c]}})();"]
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return function(d){var b={},c=document.location.search;0\u003Cc.length\u0026\u0026c.slice(1).split(\"\\x26\").forEach(function(a){a=a.split(\"\\x3d\");return b[a[0]]=a[1]});return b[d]}})();"]
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){function d(b){return b.map(function(b){var a=",["escape",["macro",28],8,16],"(b);return a?b+\"\\x3d\"+a:void 0}).filter(Boolean)}var a=\"cid_co cid_ch cid_ca CID_CO CID_CH CID_CA\".split(\" \"),g=\"cid_me cid_so cid_te cid_su cid_au cid_da cid_pr cid_psc cid_psa CID_ME CID_SO CID_TE CID_SU CID_AU CID_DA CID_PR CID_PSC CID_PSA\".split(\" \"),e=[\"utm_medium\",\"utm_source\"],h=[\"utm_campaign\",\"utm_content\",\"utm_term\"];a=d(a);g=d(g);e=d(e);h=d(h);var k=",["escape",["macro",28],8,16],"(\"gclid\"),l=",["escape",["macro",28],8,16],"(\"gclsrc\"),\nm=",["escape",["macro",28],8,16],"(\"_gac\"),f=document.referrer.replace(\/[a-zA-Z0-9:\\\/\\-]+\/,\"\").split(\"\/\")[0].split(\"?\")[0],p=document.location.hostname.replace(\/[a-zA-Z0-9:\\\/\\-]+\/,\"\").split(\"\/\")[0].split(\"?\")[0],c=",["escape",["macro",28],8,16],"(\"CID\")||",["escape",["macro",28],8,16],"(\"cid\")||\"\",q=",["escape",["macro",28],8,16],"(\"CID_CH\")||",["escape",["macro",28],8,16],"(\"cid_ch\")||\"\",r=",["escape",["macro",28],8,16],"(\"utm_medium\")||\"\",n=",["escape",["macro",27],8,16],"(\"gtm_campaignStr\"),t=window.localStorage.getItem(\"gtm_visitorAddedItems\");if(t\u0026\u0026n\u0026\u0026(c.match(\/\\|(aff|aff[a-zA-Z]+)\\|\/i)||\nq.match(\/^aff\/i)||r.match(\/^(aff|affiliate)\/i)))var b=n||\"\";else 2===e.length?b=e.concat(h).join(\".\"):3===a.length?b=a.concat(g).join(\".\"):\"\"!==c?8===c.split(\"-\").length?b=c.replace(\/\\-\/g,\"|\"):\"\"===c\u0026\u0026document.location.hostname.match(\/promo\\.\/i)?(a=document.location.pathname.split(\"\/\"),a.forEach(function(a){8===a.split(\"-\").length?b=a.split(\"-\").join(\"|\"):8===a.split(\"|\").length\u0026\u0026(b=a)})):b=c:b=k||l||m?k||l||m:\"\"===f||-1===p.indexOf(f)\u0026\u0026-1===f.indexOf(\".zendesk.\")?f||\"direct\":\"\";return b})();"]
    },{
      "function":"__k",
      "convert_case_to":1,
      "vtp_decodeCookie":true,
      "vtp_name":"gtm_campaignStr"
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return function(c,b){var a=document.createElement(\"script\");a.src=c;a.async=1;b?a.onload=b:void 0;document.getElementsByTagName(\"head\")[0].appendChild(a)}})();"]
    },{
      "function":"__j",
      "vtp_name":"window.digitalData.cart"
    },{
      "function":"__j",
      "vtp_name":"window.digitalData.product"
    },{
      "function":"__j",
      "convert_case_to":1,
      "vtp_name":"window.digitalData.user.profile.profileInfo.emailAddress"
    },{
      "function":"__j",
      "convert_case_to":1,
      "vtp_name":"window.digitalData.user.profile.profileInfo.userPurchaseClass"
    },{
      "function":"__remm",
      "vtp_setDefaultValue":false,
      "vtp_input":["macro",1],
      ...
      "vtp_ignoreCase":true,
      "vtp_map":["list",["map","key","(category|browse\\sstyle)","value","category"],["map","key","product\\sdetail","value","product"]]
    }],
  "tags":[{
      "function":"__gclidw",
      "once_per_event":true,
      ...
      "vtp_groupTag":"snapf005",
      "vtp_useImageTag":false,
      "vtp_activityTag":"snapf0",
      "vtp_ordinalType":"STANDARD",
      "vtp_conversionCookiePrefix":"_gcl",
      "vtp_advertiserId":"5179445",
      ...
      "vtp_conversionLabel":"-8AiCNmk7wEQzaKr9wM",
      "vtp_rdp":false,
      "vtp_url":["macro",5],
      ...
      "function":"__fls",
      "once_per_event":true,
      "vtp_customVariable":["list",["map","key","u1","value",["macro",12]],["map","key","u2","value",["macro",16]],["map","key","u3","value",["macro",17]]],
      "vtp_revenue":["macro",19],
      "vtp_enableConversionLinker":true,
      "vtp_countingMethod":"TRANSACTIONS",
      "vtp_orderId":["macro",14],
      "vtp_enableProductReporting":false,
      "vtp_groupTag":"snapf00",
      "vtp_useImageTag":false,
      "vtp_activityTag":"snapf0",
      "vtp_conversionCookiePrefix":"_gcl",
      "vtp_advertiserId":"5179445",
      ...
      "vtp_conversionId":"1055576397",
      "vtp_currencyCode":["macro",9],
      "vtp_conversionLabel":"o6FFCNGl7wEQzaKr9wM",
      "vtp_url":["macro",5],
      "vtp_enableProductReportingCheckbox":true,
      "vtp_enableNewCustomerReportingCheckbox":false,
      "vtp_enableEnhancedConversionsCheckbox":false,
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Evar _tvq=window._tvq=window._tvq||[];(function(){var c=\"https:\"==document.location.protocol?\"https:\/\/collector-4220.tvsquared.com\/\":\"http:\/\/collector-4220.tvsquared.com\/\";_tvq.push([\"setSiteId\",\"TV-54727290-1\"]);_tvq.push([\"setTrackerUrl\",c+\"tv2track.php\"]);_tvq.push([function(){this.deleteCustomVariable(5,\"page\")}]);var a=document,b=a.createElement(\"script\");a=a.getElementsByTagName(\"script\")[0];b.type=\"text\/javascript\";b.defer=!0;b.async=!0;b.src=c+\"tv2track.js\";a.parentNode.insertBefore(b,a)})();\n_tvq.push([\"trackPageView\"]);\u003C\/script\u003E",
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Evar _tvq=window._tvq=window._tvq||[];\n(function(){var d={user:",["escape",["macro",21],8,16],"},e=\"sale\",f={rev:",["escape",["macro",19],8,16],",prod:",["escape",["macro",17],8,16],",id:",["escape",["macro",14],8,16],",promo:",["escape",["macro",22],8,16],"},c=\"https:\"==document.location.protocol?\"https:\/\/collector-4220.tvsquared.com\/\":\"http:\/\/collector-4220.tvsquared.com\/\";_tvq.push([\"setSiteId\",\"TV-54727290-1\"]);_tvq.push([\"setTrackerUrl\",c+\"tv2track.php\"]);_tvq.push([function(){this.setCustomVariable(5,\"session\",JSON2.stringify(d),\"visit\")}]);_tvq.push([function(){this.setCustomVariable(5,e,\nJSON2.stringify(f),\"page\")}]);_tvq.push([\"trackPageView\"]);var a=document,b=a.createElement(\"script\");a=a.getElementsByTagName(\"script\")[0];b.type=\"text\/javascript\";b.defer=!0;b.async=!0;b.src=c+\"tv2track.js\";a.parentNode.insertBefore(b,a)})();\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":22
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript data-gtmsrc=\"https:\/\/js.adsrvr.org\/up_loader.1.1.0.js\" type=\"text\/gtmscript\"\u003E\u003C\/script\u003E\n\u003Cscript type=\"text\/gtmscript\"\u003Ettd_dom_ready(function(){if(\"function\"===typeof TTDUniversalPixelApi){var a=new TTDUniversalPixelApi;a.init(\"drpwo19\",[\"v57l933\"],\"https:\/\/insight.adsrvr.org\/track\/up\")}});\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":41
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003E(function(a,c,b){if(!a[b]){a.GlobalAdalyserNamespace=a.GlobalAdalyserNamespace||[];a.GlobalAdalyserNamespace.push(b);a[b]=function(){(a[b].q=a[b].q||[]).push(arguments)};a[b].q=a[b].q||[];var d=c.createElement(\"script\");c=c.getElementsByTagName(\"script\")[0];d.async=1;d.src=\"\/\/c0.adalyser.com\/adalyser.js?cid\\x3dsnapfish\";c.parentNode.insertBefore(d,c)}})(window,document,\"adalyserTracker\");\nwindow.adalyserTracker(\"create\",{campaignCookieTimeout:15552E3,conversionCookieTimeout:604800,clientId:\"snapfish\",trafficSourceInternalReferrers:[\"^(.*\\\\.)?snapfish.com.au$\"]});window.adalyserTracker(\"trackSession\",\"lce1\",{});\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":45
      ...
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003E(function(){var a=parseFloat(",["escape",["macro",24],8,16],"||\"0\").toFixed(2);window.adalyserTracker(\"trackEvent\",\"lce3\",{value:a},!0)})();\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":46
...
return null},Hd=!1;if(H.querySelectorAll)try{var Id=H.querySelectorAll(":root");Id&&1==Id.length&&Id[0]==H.documentElement&&(Hd=!0)}catch(a){}var Dd=Hd;var Wd={},L=null,Xd=Math.random();Wd.B="GTM-M2ZN4MM";Wd.hc="b41";Wd.gi="";var Yd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Zd={__paused:!0,__tg:!0},$d;for($d in Yd)Yd.hasOwnProperty($d)&&(Zd[$d]=!0);var ae="www.googletagmanager.com/gtm.js";
...
Y.a.fls=[],function(){function a(b,c){c=c?c.slice(0,-1):void 0;Kj(b,c)}(function(b){Y.__fls=b;Y.__fls.b="fls";Y.__fls.g=!0;Y.__fls.priorityOverride=0})(function(b){var c;if(b.vtp_enableProductReporting){var d=function(t){t=t||[];for(var n=[],u=[["i","id"],["p","price"],["q","quantity"],["c","country"],["l","language"],["a","accountId"]],v=0;v<t.length;v++)for(var x=0;x<u.length;x++){var y=u[x],w=t[v][y[1]];void 0!==w&&n.push(y[0]+
(v+1)+":"+X(w))}return n.join("|")};switch(b.vtp_dataSource){case "DATA_LAYER":c=d(lm("ecommerce.purchase.products"));break;case "JSON":c=d(b.vtp_productData);break;case "STRING":for(var e=(b.vtp_productData||"").split("|"),f=0;f<e.length;f++){var h=e[f].split(":");h[1]=h[1]&&X(h[1])||"";e[f]=h.join(":")}c=e.join("|")}}var k=!b.hasOwnProperty("vtp_enableConversionLinker")||b.vtp_enableConversionLinker,l=bn(b.vtp_customVariable||
[],"key","value")||{},q={Ab:b.vtp_activityTag,hd:k,Xa:b.vtp_conversionCookiePrefix||void 0,kc:b.vtp_revenue,Y:"ITEM_SOLD"===b.vtp_countingMethod?6:5,jd:b.vtp_advertiserId,md:b.vtp_groupTag,F:b.vtp_gtmOnFailure,H:b.vtp_gtmOnSuccess,vc:b.vtp_useImageTag?void 0:b.vtp_url,zd:c,protocol:"",Ed:b.vtp_quantity,Hd:!b.vtp_useImageTag,Dc:b.vtp_transactionVariable,transactionId:b.vtp_orderId,Ec:b.vtp_userVariable,Ld:l},r=!Ad(C.s)&&void 0!=lm(C.M)&&!1!==lm(C.M);q.Lb=r;if(b.vtp_enableAttribution){var p=b.vtp_attributionFields||
[];if(p.length){N("//www.gstatic.com/attribution/collection/attributiontools.js",function(){a(q,V("google_attr").build([bn(p,"key","value")||{}]))},b.vtp_gtmOnFailure);return}}a(q)})}();Y.a.r=["google"],function(){(function(a){Y.__r=a;Y.__r.b="r";Y.__r.g=!0;Y.__r.priorityOverride=0})(function(a){return Da(a.vtp_min,a.vtp_max)})}();
...
"ea");f("vtp_eventLabel","el");f("vtp_eventValue","ev");d.push(e);b.vtp_gtmOnSuccess()}else if(a)b.vtp_gtmOnSuccess();else try{N("//bat.bing.com/bat.js",function(){var h=yc(V("UET"),{ti:b.vtp_tagId,q:d});G[c]=h;h.push("pageLoad");b.vtp_gtmOnSuccess()},b.vtp_gtmOnFailure),a=!0}catch(h){I(b.vtp_gtmOnFailure)}})}();
